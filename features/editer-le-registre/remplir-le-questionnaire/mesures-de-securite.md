...
[**Artikel 30 Abs. 1 Buchst. g) der DSGVO**](https://dsgvo-gesetz.de/art-30-dsgvo/) verlangt, im Verzeichnis "_soweit möglich, eine allgemeine Beschreibung der technischen und organisatorischen Sicherheitsmaßnahmen gemäß_ [_**Artikel 32 Absatz 1**_](https://dsgvo-gesetz.de/art-32-dsgvo/)" einzutragen.

Jeder Verantwortliche oder Auftragsverarbeiter ist gemäß den [**Artikeln 5 Abs. 1 Buchst. f)**](https://dsgvo-gesetz.de/art-5-dsgvo/) und [**32**](https://dsgvo-gesetz.de/art-32-dsgvo/) der DSGVO verpflichtet, die Sicherheit der Daten durch dem Risikoniveau angemessene Maßnahmen zu gewährleisten.
...
Damit die Maßnahmen dem Risiko angemessen sind, müssen diese Risiken bewertet werden. Dazu sind die potenziellen Auswirkungen auf die Datensicherheit, die Risikoquellen, die realisierbaren Bedrohungen zu identifizieren und zu bewerten, ob die bestehenden Maßnahmen ausreichend sind. Falls nicht, müssen sie verstärkt werden.<br>
