...
{% hint style="info" %}
Der Freigabelink ist ein zeitlich begrenzter Link, den Sie verwenden können, um das Verzeichnis mit externen Nutzern zu teilen. Der Link ist öffentlich sichtbar, daher ist Vorsicht bei der Verbreitung geboten. Aus Sicherheitsgründen wird empfohlen, die exponierten Freigabelinks in Ihrem Projekt zu überwachen.
{% endhint %}

## **Generierung eines Freigabelinks für eine Datenverarbeitung**

Wiederholen Sie den oben beschriebenen Vorgang, aber gehen Sie in die Verarbeitung, die Sie teilen möchten. Klicken Sie dann auf den Pfeil neben der Schaltfläche Speichern und dann auf "Teilen".
