...
{% hint style="info" %}
Ein guter Ansatz, um mit der Erstellung Ihres Verarbeitungsverzeichnisses zu beginnen, ist zunächst Ihre bestehenden Verzeichnisse im Excel-Format zu importieren, sofern vorhanden, sowie Ihre Referenzdaten zu Stakeholdern, Anwendungen, Auftragsverarbeitern, Daten und Aufbewahrungsregeln. Wenn alle Referenzdaten einmal integriert sind, sparen Sie bei der Eingabe Zeit.
{% endhint %}

Füllen Sie dann alle für eine Verarbeitung erforderlichen Informationen aus, indem Sie den im folgenden Link beschriebenen Schritten folgen.
...
Das war's, **Ihr Verarbeitungsverzeichnis ist erstellt** und Ihre Verarbeitungen sind bereit, geschützt zu werden!
